...
if test "$PHP_FEATHERS" = "yes"; then
	...
	feathers_sources="feathers.c kernel/main.c kernel/memory.c kernel/exception.c kernel/hash.c kernel/debug.c kernel/backtrace.c kernel/object.c kernel/array.c kernel/extended/array.c kernel/string.c kernel/fcall.c kernel/require.c kernel/file.c kernel/operators.c kernel/concat.c kernel/variables.c feathers/http/methods.c feathers/http/statuscodes.c feathers/router/destinationinterface.c feathers/router/route.c feathers/router/router.c "
