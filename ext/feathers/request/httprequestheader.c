...
ZEPHIR_INIT_CLASS(Feathers_Request_HttpRequestHeader) {
	...
	ZEPHIR_REGISTER_CLASS(Feathers\\Request, HttpRequestHeader, feathers, request_httprequestheader, feathers_request_httprequestheader_method_entry, 0);

	zend_declare_property_null(feathers_request_httprequestheader_ce, SL("_name"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(feathers_request_httprequestheader_ce, SL("_value"), ZEND_ACC_PRIVATE TSRMLS_CC);
