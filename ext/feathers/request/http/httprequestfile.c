...
ZEPHIR_INIT_CLASS(Feathers_Request_Http_HttpRequestFile) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Feathers\\Request\\Http, HttpRequestFile, feathers, request_http_httprequestfile, feathers_types_io_fileabstract_ce, feathers_request_http_httprequestfile_method_entry, 0);
