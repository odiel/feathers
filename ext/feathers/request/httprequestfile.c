...
ZEPHIR_INIT_CLASS(Feathers_Request_HttpRequestFile) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Feathers\\Request, HttpRequestFile, feathers, request_httprequestfile, feathers_types_io_fileabstract_ce, feathers_request_httprequestfile_method_entry, 0);
